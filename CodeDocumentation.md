...
Description:
A virtually simulated drone using the MuJoCo library.
...
Child class of Drone. Extends Drone class with a hanging hook for picking up objects.
