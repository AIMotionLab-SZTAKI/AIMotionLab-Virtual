...
def receive_rigid_body_frame( new_id, position, rotation ):
    #pass
    #print("#########################################################xx received rigid body frame")
...
if __name__ == "__main__":
    ...
    optionsDict = {}
    optionsDict["clientAddress"] = "192.168.1.56"
    optionsDict["serverAddress"] = '192.168.1.141'
    ...
    #streaming_client.set_server_address('192.168.1.141')
